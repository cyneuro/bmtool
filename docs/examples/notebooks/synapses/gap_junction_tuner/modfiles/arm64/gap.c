...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 Gap /Users/gregglickert/Documents/GitHub/bmtool/docs/examples/notebooks/synapses/gap_junction_tuner/modfiles/gap.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/gregglickert/Documents/GitHub/bmtool/docs/examples/notebooks/synapses/gap_junction_tuner/modfiles/gap.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "  POINT_PROCESS Gap\n"
  "  ELECTRODE_CURRENT i\n"
