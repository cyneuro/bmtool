...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 shock2int /home/gjgpb9/LargeScaleBLA/components_homogenous/mechanisms/modfiles/shock2int.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 170 in file shock2int.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/gjgpb9/LargeScaleBLA/components_homogenous/mechanisms/modfiles/shock2int.mod";
  ...
  "	\n"
  "	Cdur_gaba = 0.7254 (ms)\n"
  "	AlphaTmax_gaba = 7.2609 :1.52 (/ms):7.2609 (/ms): 2.2609 (/ms): 3.2609 (/ms)   : 7.2609 as original\n"
