...
#define nrn_init _nrn_init__AMPA_NMDA_STP_PN2PN
#define _nrn_initial _nrn_initial__AMPA_NMDA_STP_PN2PN
#define nrn_cur _nrn_cur__AMPA_NMDA_STP_PN2PN
#define _nrn_current _nrn_current__AMPA_NMDA_STP_PN2PN
#define nrn_jacob _nrn_jacob__AMPA_NMDA_STP_PN2PN
#define nrn_state _nrn_state__AMPA_NMDA_STP_PN2PN
#define _net_receive _net_receive__AMPA_NMDA_STP_PN2PN 
#define state state__AMPA_NMDA_STP_PN2PN 
...
#define toggleVerbose toggleVerbose_AMPA_NMDA_STP_PN2PN
 extern double toggleVerbose( _threadargsproto_ );
 /* declare global and static user variables */
#define nc_type_param nc_type_param_AMPA_NMDA_STP_PN2PN
 ...
 {"nc_type_param_AMPA_NMDA_STP_PN2PN", &nc_type_param_AMPA_NMDA_STP_PN2PN},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _AMPA_NMDA_STP_PN2PN_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 pnt_receive_size[_mechtype] = 8;
 	...
 	ivoc_help("help ?1 AMPA_NMDA_STP_PN2PN /home/gjgpb9/LargeScaleBLA/components_homogenous/mechanisms/modfiles/AMPA_NMDA_STP_PN2PN.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/gjgpb9/LargeScaleBLA/components_homogenous/mechanisms/modfiles/AMPA_NMDA_STP_PN2PN.mod";
  ...
  "    THREADSAFE\n"
  "\n"
  "    POINT_PROCESS AMPA_NMDA_STP_PN2PN\n"
  ...
  "    tau_d_AMPA = 6.9   (ms)  : IMPORTANT: tau_r < tau_d\n"
  "    tau_r_NMDA = 3.7  (ms)  : Dual-exponential conductance profile\n"
  "    tau_d_NMDA = 125    (ms)  : IMPORTANT: tau_r < tau_d\n"
  "    Use = 0.15         (1)   : Utilization of synaptic efficacy\n"
  "    Dep = 200          (ms)  : Relaxation time constant from depression\n"
