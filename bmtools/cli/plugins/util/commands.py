...
@click.pass_context
def cell_tune(ctx,hoc_folder,mod_folder,template,easy,write_hoc,hide,title):#, title, populations, group_by, save_file):
  
    if not check_neuron_installed():
        return

    from .neuron.celltuner import CellTunerGUI, PlotWidget, ControlMenuWidget
